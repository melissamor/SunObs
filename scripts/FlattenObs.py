...
Fits a function of your specifications to the spectrum and divides spectrum
    by that function in order to flatten the spectrum

***NOT VERY EFFECTIVE FOR REDUCING DATA***

Syntax: python FlattenObs.py [name of observation file]
'''
import numpy as np
...
if __name__ == '__main__':
    ...
    import sys
    #name = sys.argv[1]
    name = '../observation_10-25-2017_1.dat'
    exist = "no" #sys.argv[2]
    fil = open(name,'r')
    one = fil.readline()
    two = fil.readline()
